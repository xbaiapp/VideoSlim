...
> **当前状态（2026-07-24）：** M4-B/F8 `1.8.0+24 / 9351e75...`仍是项目所有者已接受的私有基线，C2/F21 `1.9.0+25 / 11f169c...`的Pixel 10 Pro/API 37证据保持冻结。一次性自动软件解码重试`1.9.1+26 / 8f4e970...`已形成新的私有ARM64候选，静态门禁与APK核验通过，真机验收PENDING；独立exact-state review超时无裁决，控制器已在唯一修订中关闭两个attempt-boundary问题。C1b/C3及M4-C仍未授权。完整进度见`docs/current-project-status.md`。
