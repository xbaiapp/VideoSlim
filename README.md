...
> **当前状态（2026-07-23）：** M3 `1.4.3+18` 仍是已接受私有基线。`1.6.0+21` 已完成“无来源时间时覆盖Media3处理时间并核验必无字段”的额外修订、完整自动化门禁和focused exact-SHA review，当前仅待真实来源/设备验收。M4-B时间裁剪仍未授权。完整进度见 `docs/current-project-status.md`。
