...
> **当前状态（2026-07-23）：** M4-B/F8 `1.8.0+24 / 9351e75...`仍是项目所有者已接受的私有基线。C2/F21只读本机编码器能力诊断已形成`1.9.0+25 / 11f169c...`私有ARM64候选，exact自动门禁与APK静态核验通过；纠正SHA无独立review PASS，真机能力清单仍PENDING。C1b/C3及M4-C仍未授权。完整进度见`docs/current-project-status.md`。
