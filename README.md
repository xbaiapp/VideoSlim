...
> **当前状态（2026-07-23）：** M4-B/F8 `1.8.0+24 / 9351e75...`已由项目所有者报告测试成功并接受为私有基线；未提供的逐项设备矩阵继续保持PENDING。下一独立代码项C2/F21本机编码器能力诊断已获准实施；C1b/C3及M4-C仍未授权。完整进度见`docs/current-project-status.md`。
