...
> **当前状态（2026-07-23）：** M3 `1.4.3+18` 仍是已接受私有基线。当前 `1.7.0+23 / 7c49e57...` 在既有M4-A、时间/GPS和日志修复之上增加C1a低收益/可能变大提示，自动化和APK静态核验通过，真机验收仍待执行。C1b/C2/C3及M4-B/M4-C仍未授权。完整进度见 `docs/current-project-status.md`。
