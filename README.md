...
> **当前状态（2026-07-23）：** M3 `1.4.3+18` 仍是已接受私有基线。`1.6.0+21` 的拍摄时间/GPS候选因exact-SHA复审发现“无来源时间时可能写入处理时间”而被隔离，禁止分发和真机验收；是否额外修订等待项目所有者决定。M4-B时间裁剪仍未授权。完整进度见 `docs/current-project-status.md`。
