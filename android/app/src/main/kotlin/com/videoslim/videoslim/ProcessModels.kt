...
enum class EngineErrorCode(
    ...
    NO_AUDIO_TRACK("NO_AUDIO_TRACK", "所选文件没有可提取的音轨"),
    AUDIO_FORMAT_UNSUPPORTED("AUDIO_FORMAT_UNSUPPORTED", "当前音频格式不支持所选提取方式"),
    AUDIO_CHANNELS_UNSUPPORTED("AUDIO_CHANNELS_UNSUPPORTED", "首版仅支持单声道或双声道音频"),
